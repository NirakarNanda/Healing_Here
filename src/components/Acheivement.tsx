...
const achievements: Achievement[] = [
  ...
  { mediaSrc: '/assets/acheivements/Vertebrae.mp4', mediaType: 'video', title: 'Treatment of a Prolapsed Intervertebral Disc (PIVD)', description: "This video showcases the results after just two sessions of Dr. Abhilash Nanda's treatment for a patient with a Prolapsed Intervertebral Disc (PIVD). Witness the remarkable improvement in the patient's condition as Dr. Nanda applies his specialized physiotherapy techniques, demonstrating his expertise in diagnosing, treating, and rehabilitating complex spinal conditions." },
