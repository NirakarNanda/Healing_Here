...
export const CTASection = () => {
  return (
    <section className="flex flex-col">
      <div className="bg-[#516EFF] px-4 py-8 sm:px-28 sm:py-16 flex flex-col lg:flex-row items-center gap-10 lg:gap-44">
        <div className="flex flex-col gap-4 text-white">
          <h2 className="text-4xl font-semibold">How to get our services?</h2>
